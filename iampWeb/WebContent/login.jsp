...
<div class="box">
	<div class="login-top">
		<div class="top-left"><a style="color:#ffffff">京华智慧化支撑平台-管理控制台</a></div>
		<div class="top-right">
			<a href="#">帮助</a>
		</div>
	</div>
	<div class="login-box">
		...
		<div class="box-right">
			<div class="right-title"><span>用户登录</span><spam>UserLogin</spam></div>
			<div class="login-input">
				<ul>
					<li><input type="text" name="userName" lay-verify="title" autocomplete="off" placeholder="用户名" class="login-name">
					<div class="name-icon"><i class="iconfont  icon-ren1"  style="font-size: 18px;"></i></div></li>
					
					<li><input type="password" name="password" lay-verify="title" autocomplete="off" placeholder="密码" class="login-name">
					<div class="name-icon"><i class="iconfont  icon-mima"  style="font-size: 18px;"></i></div></li>
					
				</ul>
				<div class="btn-login" id="loginBtn"><a href="javascript:void(0)" class="" >登录</a></div>
			</div>
