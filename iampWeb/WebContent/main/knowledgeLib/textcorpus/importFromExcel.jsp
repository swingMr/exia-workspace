...
<body>
	<div>	
 	<form class="layui-form" action="/iamp/textcorpus/createCorpus.do" id="form" enctype="multipart/form-data" method="post">
		  ...
		  <div class="layui-form-item">
		    <label class="layui-form-label">选择文件：</label>
	    		<div class="layui-input-block" style="width:425px">
