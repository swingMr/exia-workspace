...
<script language="JavaScript" type="text/javascript" src="/iamp/js/layui-v2/layui.js" ></script>
...
<!--  <script src="/exEye/js/swfupload/handlers.js" type="text/javascript"></script> -->
<link href="/iamp/css/fonts/iconfont.css" rel="stylesheet" type="text/css">
<link href="/iamp/js/layui-v2/css/layui.css" rel="stylesheet" type="text/css" />  
<link href="/iamp/js/layui-v2/css/style.css" rel="stylesheet" type="text/css"> 
</head>
<%
...
$(function() {
    var settings_object = {//定义参数配置对象
        	upload_url : "/iamp/resource/uploadFile.do",
...
function upload_start_function(file) {
	...
	var fileNum = swfu.getStats().files_queued;
	var postobj = {"libNum": libNum,"catalogNum":catalogNum,"catalogId":catalogId,"fileNum":fileNum,"fileName":fileName};
