 	...
 	<table lay-skin="nob" class="layui-table">
		 <tr>
		  	...
		  	<td>
			    ...
			    <div class="layui-input-block">
			      <input style="border:none;outline:medium;" disabled="disabled" type="text" id="issuedNum" name="title"  value="${!empty obj? obj.issuedNum:''}"  placeholder="" autocomplete="off" class="layui-input">
			    </div>
	    	</td>
    	</tr>
     	<tr>
    		<td >
			    ...
			    <div class="layui-input-block">
			      <input style="border:none;outline:medium;" disabled="disabled" type="text" id="title" name="title" required value="${!empty obj? obj.title:''}" lay-verify="required" placeholder="" autocomplete="off" class="layui-input">
			    </div>
    		</td>
    		<td>
    			<label class="layui-form-label">版本号：</label>
			    <div class="layui-input-block">
					<input style="border:none;outline:medium;" disabled="disabled" type="text" id="version" name="title"  value="${obj.version!=null ? obj.version:'1.0'}"  placeholder="" autocomplete="off" class="layui-input">
			    </div>
    		</td>
    	</tr>
		<tr >
		  	<td>
			    ...
			    <div class="layui-input-block">
					<input style="border:none;outline:medium;" disabled="disabled" type="text" id="publisher" name="title"  value="${!empty obj? obj.publisher:''}"  placeholder="" autocomplete="off" class="layui-input">
			    </div>
	    	</td>
		  	<td>
				<label class="layui-form-label">发布日期：</label>
					<div class="layui-input-block" >
					  <input style="border:none;outline:medium;" disabled="disabled" class="layui-input" id="publishDate" onclick="layui.laydate({elem: this, festival: true,istime: true,format:'YYYY-MM-DD'})" value="${publishDate}" style="width:70%;display:inline;">
					</div>
		...
		<tr >
		  	<td>
			    ...
			    <div class="layui-input-block">
			      <input style="border:none;outline:medium;" disabled="disabled" type="text" id="belongDomainList"  name="title"  value="${!empty obj.domainstr? obj.domainstr:''}"  placeholder="" autocomplete="off" class="layui-input">
			    </div>
	    	</td>
	    	<td>
		       		...
		       		<c:forEach var="list" items="${granularityList}" varStatus="status">
			       			<c:choose>
			       			  <c:when test="${ obj.granularity !=null && list == obj.granularity }"> 
							   		<input style="border:none;outline:medium;" disabled="disabled" type="text" id="belongDomainList"  name="title"  value="${list}"  placeholder="" autocomplete="off" class="layui-input">
		...
		<tr >
		  	<td >
			    ...
			    <div class="layui-input-block">
					<input  style="border:none;outline:medium;" disabled="disabled" type="text" id="genreList" name="title" required value="${!empty genreList? genreList:''}" lay-verify="required" placeholder="" autocomplete="off" class="layui-input">
			    </div>
	    	</td>
	    	<td >
				<label class="layui-form-label">来源：</label>
			    <div class="layui-input-block">
					<input  style="border:none;outline:medium;" disabled="disabled" type="text" id="source" name="title"  value="${!empty obj? obj.source:''}"  placeholder="" autocomplete="off" class="layui-input">
			    </div>
	    	</td>
	    </tr>
		<tr >
				...
				<label class="layui-form-label"><span style="color:red">*</span>有效时间：</label>
				    <div class="layui-input-block">
			      		<c:choose>     
		       		 		...
		       		 		<input  style="border:none;outline:medium;" disabled="disabled" type="text" id="source" name="title"  value="${validTime}"  placeholder="" autocomplete="off" class="layui-input">
		       		 		</c:when>
		       		 	</c:choose>
				    </div>
	    	</td>
					  ...
					  <div class="layui-input-block">
					  	<c:choose>     
		       		 		<c:when test="${ obj.status!=null && obj.status=='0'}"> 
					   				 <input class="layui-input" disabled="disabled" style="border:none;outline:medium;" type="text" name="status" value="过期" >
					    			
		       		 		</c:when>
		       		 		<c:when test="${obj.status!=null && obj.status=='-1'}"> 
					    			<input class="layui-input" disabled="disabled" style="border:none;outline:medium;" type="text" name="status" value="废除" >
		       		 		</c:when>
		       		 		<c:otherwise >
		       		 				 <input class="layui-input"  disabled="disabled" style="border:none;outline:medium;" type="text" name="status" value="正常" >
			  ...
			  <div class="layui-input-block">
			  	<c:choose>     
       		 		<c:when test="${ obj.authority!=null && obj.authority=='1'}"> 
       		 		 <input class="layui-input"  disabled="disabled" style="border:none;outline:medium;" type="text" name="status" value="开放" >
       		 		</c:when>
       		 		<c:when test="${obj.authority!=null && obj.authority=='2'}"> 
       		 		 <input class="layui-input"  disabled="disabled" style="border:none;outline:medium;" type="text" name="status" value=所有登录用户" >
       		 		</c:when>
       		 		<c:when test="${obj.authority!=null && obj.authority=='3'}"> 
       		 		 <input class="layui-input"  disabled="disabled" style="border:none;outline:medium;" type="text" name="status" value="授权" >
       		 		</c:when>
       		 		<c:otherwise >
       		 		 <input class="layui-input"  disabled="disabled" style="border:none;outline:medium;" type="text" name="status" value="开放" >
       		 		</c:otherwise>
	    	...
	    	<td>
			  ...
			  <div class="layui-input-block">
			  	<c:choose>     
						...
						<input class="layui-input"  disabled="disabled" style="border:none;outline:medium;" type="text" name="status" value="确认" >

       		 		</c:when>
       		 		<c:otherwise >
<input class="layui-input"  disabled="disabled" style="border:none;outline:medium;" type="text" name="status" value="未确认" >
       		 		</c:otherwise>
       		 	</c:choose>
			  </div>
	    	</td>
		...
		<tr >
			  ...
			  <div class="layui-form-item layui-form-text">
			    ...
			    <div class="layui-input-block">
			      <textarea name="desc" disabled="disabled" id="abstractText" value="${!empty obj? obj.abstractText:''}"  placeholder="请输入内容" class="layui-textarea">${!empty obj? obj.abstractText:''}</textarea>
			    </div>
			  </div>
  	    	</td>
	    </tr>
		<tr >
		  	<td colspan="2">
			    ...
			    <div class="layui-input-inline" >
			      <input  type="text" id="originalAddress" name="title" disabled="disabled"  value="${!empty obj? obj.originalAddress:''}"  placeholder="请输入中文名称" autocomplete="off" class="layui-input" style="width:700px;float:left;position:relative;">
	  ...
	  <tbody id="attrListTbody">
	  	<c:choose>
	  		<c:when test="${method == 'create'}"><!-- 新增从Lib读属性 -->
				  ...
				  <tr>
				  		<td>
				  			<input disabled="disabled" style="border:none;outline:medium;" type="text" name="attrName" name="title" required value="${!empty obj? extendAttrs.attrName:''}" lay-verify="required"  autocomplete="off" class="layui-input">
				  		</td>
				  		<td>
				  			<input disabled="disabled" style="border:none;outline:medium;" type="text" name="attrCName" name="title" required value="${!empty obj? extendAttrs.attrCName:''}" lay-verify="required"  autocomplete="off" class="layui-input">
				  		</td>
				  		<td>
				  		...
				  		<td>
				  			<input type="text" disabled="disabled" style="border:none;outline:medium;" name="value" name="title"  value="${!empty obj? extendAttrs.value:''}"   autocomplete="off" class="layui-input">
				  		</td>
				  		<td>
	  		...
	  		<c:otherwise><!-- 修改从VO读属性 -->
		 		<c:forEach var="extendAttrs" items="${obj.extendAttrs}" varStatus="status">
				  <tr>
				  		<td>
				  			 <input disabled="disabled" style="border:none;outline:medium;" type="text" name="attrName" name="attrName" required value="${!empty obj? extendAttrs.attrName:''}" lay-verify="required"  autocomplete="off" class="layui-input">
				  		</td>
				  		<td>
				  			<input  disabled="disabled" style="border:none;outline:medium;" type="text" name="attrCName" name="attrCName" required value="${!empty obj? extendAttrs.attrCName:''}" lay-verify="required"  autocomplete="off" class="layui-input">
				  		</td>
				  		<td>
					       		 <c:choose>     
					       		 	<c:when test="${!empty extendAttrs.type && extendAttrs.type=='int'}"> 
										<input  disabled="disabled" style="border:none;outline:medium;" type="text" name="value" name="title"  value="数字"   autocomplete="off" class="layui-input">
								   </c:when>     
			 		       		 	<c:when test="${!empty extendAttrs.type && extendAttrs.type=='string'}"> 
								  		 <input  disabled="disabled" style="border:none;outline:medium;" type="text" name="value" name="title"  value="字符串"   autocomplete="off" class="layui-input">
						
								   </c:when>     
					       		 	<c:when test="${!empty extendAttrs.type && extendAttrs.type=='longtext'}"> 
							       		 <input  disabled="disabled" style="border:none;outline:medium;" type="text" name="value" name="title"  value="长文本"   autocomplete="off" class="layui-input">
								   </c:when>     
					       		 	<c:when test="${!empty extendAttrs.type && extendAttrs.type=='date'}"> 
<input  disabled="disabled" style="border:none;outline:medium;" type="text" name="value" name="title"  value="日期"   autocomplete="off" class="layui-input">
								   </c:when>     
					       		 	<c:when test="${!empty extendAttrs.type && extendAttrs.type=='array'}"> 
								  <input  disabled="disabled" style="border:none;outline:medium;" type="text" name="value" name="title"  value="数组"   autocomplete="off" class="layui-input">
								   </c:when>   
								   <c:otherwise>
<input  disabled="disabled" style="border:none;outline:medium;" type="text" name="value" name="title"  value="数字"   autocomplete="off" class="layui-input">
								   </c:otherwise>  
				  		...
				  		<td>
				  			 <c:choose>     
					       		 <c:when test="${!empty extendAttrs.type && extendAttrs.type=='date'}"> 
					       			 <input  disabled="disabled" style="border:none;outline:medium;" class="layui-input" name="value"  onclick="layui.laydate({elem: this, festival: true,istime: true,format:'YYYY-MM-DD'})" value="${!empty obj? extendAttrs.value:''}" >
					       		 </c:when>
					       		 <c:otherwise>
					       		 	<input  disabled="disabled" style="border:none;outline:medium;" type="text" name="value" name="title"  value="${!empty obj? extendAttrs.value:''}"   autocomplete="off" class="layui-input">
					       		 </c:otherwise>
					       	</c:choose>
				  		</td>
				  		<td>
	...
	<blockquote class="layui-elem-quote">关联标签 </blockquote>
	<div id="tagDiv">
		...
		<c:choose>     
		 	...
		 	关联领域：  <c:set var="tagList" value="${tag.value}" /> 
					<c:forEach var="tagVal" items="${tagList}" varStatus="status">
						<span class="layui-btn layui-btn-small domains" value="${tagVal.similarity}" style="margin:10px;">${tagVal.content}</span>
					</c:forEach><br>
	 		</c:when>
		 	<c:when test="${ tag.key!=null && tag.key=='acts' && tag.value != '[]'}"> 
		 	关联行为：  <c:set var="tagList" value="${tag.value}" /> 
					<c:forEach var="tagVal" items="${tagList}" varStatus="status">
						<span class="layui-btn layui-btn-small acts" value="${tagVal.similarity}" style="margin:10px;">${tagVal.content}</span>
					</c:forEach><br>
	 		</c:when>
		 	<c:when test="${ tag.key!=null && tag.key=='organdpersons' && tag.value != '[]'}"> 
		 	关联主体：  <c:set var="tagList" value="${tag.value}" /> 
					<c:forEach var="tagVal" items="${tagList}" varStatus="status">
						<span class="layui-btn layui-btn-small organdpersons" value="${tagVal.similarity}" style="margin:10px;">${tagVal.content}</span>
					</c:forEach><br>
	 		</c:when>
		 	<c:when test="${ tag.key!=null && tag.key=='objects' && tag.value != '[]'}"> 
		 	关联客体：  <c:set var="tagList" value="${tag.value}" /> 
					<c:forEach var="tagVal" items="${tagList}" varStatus="status">
						<span class="layui-btn layui-btn-small objects" style="margin:10px;" value="${tagVal.similarity}">${tagVal.content}</span>
					</c:forEach><br>
	 		</c:when>
		 	<c:when test="${ tag.key!=null && tag.key=='spaces' && tag.value != '[]'}"> 
		 	关联空间：  <c:set var="tagList" value="${tag.value}" /> 
					<c:forEach var="tagVal" items="${tagList}" varStatus="status">
						<span class="layui-btn layui-btn-small spaces" style="margin:10px;" value="${tagVal.similarity}">${tagVal.content}</span>
					</c:forEach><br>
	 		</c:when>
		 	<c:when test="${ tag.key!=null && tag.key=='times' && tag.value != '[]'}"> 
		 	关联时间:  <c:set var="tagList" value="${tag.value}" /> 
					<c:forEach var="tagVal" items="${tagList}" varStatus="status">
						<span class="layui-btn layui-btn-small times" style="margin:10px;" value="${tagVal.similarity}">${tagVal.content}</span>
					</c:forEach><br>
	 		</c:when>
		 	<c:when test="${ tag.key!=null && tag.key=='keywords' && tag.value != '[]'}"> 
		 	关联关键词：  <c:set var="tagList" value="${tag.value}" /> 
					<c:forEach var="tagVal" items="${tagList}" varStatus="status">
						<span class="layui-btn layui-btn-small keywords" style="margin:10px;" value="${tagVal.similarity}">${tagVal.content}</span>
					</c:forEach><br>
	 		</c:when>
		 	<c:when test="${ tag.key!=null && tag.key=='hierarchy' && tag.value != '[]'}"> 
		 	关联行政层级：  <c:set var="tagList" value="${tag.value}" /> 
					<c:forEach var="tagVal" items="${tagList}" varStatus="status">
						<span class="layui-btn layui-btn-small hierarchy" style="margin:10px;" value="${tagVal.similarity}">${tagVal.content}</span>
					</c:forEach><br>
	 		</c:when>
		</c:choose>	
	</c:forEach>
...
function submit(){
	...
	$("#genreList").on("click",function(){
		...
		layer.open({
			...
			area: ['355px', '500px'],
			btnAlign: 'c',
			content:"/iamp/resource/getTree.do?rootName="+encodeURI(encodeURI("体裁")),
			btn: ['确定', '取消'],
			yes: function(index, layero){
			    ...
			    var conceptNames =  genres.replace(";", ",");
		    	$.post(
			    		ajaxGetConcepts,
			    		{
			    			"names":conceptNames
	...
	function setTag(){
		var tag = '<span class="layui-btn layui-btn-small tagSpan" style="margin:10px;"></span>';
		return tag;
	}
