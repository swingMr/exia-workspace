...
<%
	String rootName = request.getAttribute("rootName")==null ? "领域实例" : (String)request.getAttribute("rootName"); 
	String postUrl = request.getAttribute("postUrl")==null ? "/iamp/ontologyRule/getChildDomain" : (String)request.getAttribute("/iamp/ontologyRule/getChildDomain"); 
 %>
<body>
