...
<body >
	<div style="margin-left:5px;">
		<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
		  <legend typeVal="file.convertTxt">2. 文件转成TXT</legend>
		</fieldset>
		<blockquote class="layui-elem-quote">
		    支持DOC、DOCX、DOT、DOTX、PPT、PPTX、XLS、XLSX、XML、HTML、HTM、PDF转成一个TXT文件。
		</blockquote> 
		
		<!--  -->
		<span class="method">1.1 上传一个文件并转成TXT文件</span>
		...
		<thead>
			<tr><td class="titleName">方法路径</td><td colspan="3">/ExIAServer/services/file/convert/txt/upload</td></tr>
		</thead>
			<tr><td class="titleName">调用方式</td><td colspan="3">HTTP请求</td></tr>
			<tr><td class="titleName">方法功能</td><td colspan="3">上传一个临时文件，并把文件转成TXT。如果本身就是一个TXT，不用进行转换。</td></tr>
		...
		<!--  -->
		<span class="method">2.2 把指定临时文件转成TXT文件</span>
		...
		<table class="layui-table"  lay-skin="line" style="width:100%">
		<thead>
			<tr><td class="titleName">方法路径</td><td colspan="3">/ExIAServer/services/file/convert/txt/upload/{临时文件的唯一标识}</td></tr>
		</thead>
			<tr><td class="titleName">调用方式</td><td colspan="3"></td></tr>
			<tr><td class="titleName">方法功能</td><td colspan="3">把指定临时文件转成TXT文件，如果文件本身就是TXT，那不用转换，返回该文件ID。</td></tr>
