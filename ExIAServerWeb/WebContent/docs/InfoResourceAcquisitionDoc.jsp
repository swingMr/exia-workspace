...
<body >
	<div style="margin-left:5px;">
		...
		<thead>
			...
			<tr><td class="titleName">信息资源库</td><td colspan="3">/ExIAServer/services/resdb/</td></tr>
			<tr><td class="titleName">信息资源</td><td colspan="3">/ExIAServer/services/res/</td></tr>
		</table><br>
