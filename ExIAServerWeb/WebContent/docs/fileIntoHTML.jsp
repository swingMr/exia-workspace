...
<body >
	<div style="margin-left:5px;">
		<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
		  <legend typeVal="file.convertHtml">4. 文件转成HTML</legend>
		</fieldset>
		<blockquote class="layui-elem-quote">
		     支持DOC、DOCX、DOT、DOTX、PPT、PPTX、XLS、XLSX、PDF转成一个HTML文件。
		</blockquote> 
		
		<!--  -->
		<span class="method">4.1 上传一个文件并转成HTML文件</span>
		...
		<thead>
			<tr><td class="titleName">方法路径</td><td colspan="3">/ExIAServer/services/file/convert/html/upload</td></tr>
		</thead>
			<tr><td class="titleName">调用方式</td><td colspan="3">HTTP请求</td></tr>
			<tr><td class="titleName">方法功能</td><td colspan="3">上传一个临时文件，并把文件转成HTML。如果本身就是一个HTML，不用进行转换。</td></tr>
		...
		<!--  -->
		<span class="method">4.2 把指定临时文件转成HTML文件</span>
		...
		<table class="layui-table"  lay-skin="line" style="width:100%">
		<thead>
			<tr><td class="titleName">方法路径</td><td colspan="3">/ExIAServer/services/file/convert/html/upload/{临时文件的唯一标识}</td></tr>
		</thead>
			<tr><td class="titleName">调用方式</td><td colspan="3"></td></tr>
			<tr><td class="titleName">方法功能</td><td colspan="3">把指定临时文件转成HTML文件，如果文件本身就是HTML，那不用转换，返回该文件ID。</td></tr>
