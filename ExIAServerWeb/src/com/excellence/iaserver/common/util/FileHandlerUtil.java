...
public class FileHandlerUtil {
    ...
    public static String getTxtText(InputStream fileInput){
    	...
    	StringBuffer buff = new StringBuffer();  
    	try {   
    		br = new BufferedReader(new InputStreamReader(fileInput,  "GBK"));   
	        String temp = null;   
	        while((temp = br.readLine()) != null){   
	            buff.append(temp + "\r\n");   
	        }  
     ...
     * @return
     */
    public static String htmlStirngToString(String htmlString){
		...
		try {
			...
			e.printStackTrace();
			System.out.println("html字符串转纯文本失败！原因是：" + e);
		}  
		return null;
    }
